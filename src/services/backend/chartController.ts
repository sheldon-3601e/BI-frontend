...
/** genChartByAi POST /api/chart/gender */
export async function genChartByAiUsingPost(
  ...
  return request<API.BaseResponseBiResponse_>('/api/chart/gender', {
    method: 'POST',
    params: {
      ...params,
    },
...
/** genChartByAiAsync POST /api/chart/gender/async */
export async function genChartByAiAsyncUsingPost(
  ...
  return request<API.BaseResponseBiResponse_>('/api/chart/gender/async', {
    method: 'POST',
    params: {
      ...params,
    },
...
/** genChartByAiAsyncMq POST /api/chart/gender/async/mq */
export async function genChartByAiAsyncMqUsingPost(
  ...
  return request<API.BaseResponseBiResponse_>('/api/chart/gender/async/mq', {
    method: 'POST',
    params: {
      ...params,
    },
...
/** genUpdateChartByAiAsync POST /api/chart/gender/update/async */
export async function genUpdateChartByAiAsyncUsingPost(
  // 叠加生成的Param类型 (非body参数swagger默认没有生成对象)
  params: API.genUpdateChartByAiAsyncUsingPOSTParams,
  body: {},
  file?: File,
  options?: { [key: string]: any },
) {
  ...
  return request<API.BaseResponseBiResponse_>('/api/chart/gender/update/async', {
    method: 'POST',
    params: {
      ...params,
    },
...
/** getChartInfoById GET /api/chart/get/chartInfo */
export async function getChartInfoByIdUsingGet(
  // 叠加生成的Param类型 (非body参数swagger默认没有生成对象)
  params: API.getChartInfoByIdUsingGETParams,
  options?: { [key: string]: any },
) {
  return request<API.BaseResponseListMapStringObject_>('/api/chart/get/chartInfo', {
    method: 'GET',
    params: {
      ...params,
    },
